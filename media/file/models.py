...
class EndorsementForm(models.Model):
    ...
    sanction_letter = models.FileField(upload_to='sanction_letter/', help_text="Upload 1 supported file: PDF. Max 10 MB.",null=True, blank=True)
...
class Installment(models.Model):
    ...
    file = models.FileField(upload_to='file/', help_text="Upload 1 supported file: PDF. Max 10 MB.",null=True, blank=True)
