...
class PrincipleInvestigator(models.Model):
    ...
    organization = models.ForeignKey(
        Organization,
        related_name="principle_investigators",
...
class EndorsementForm(models.Model):
    ...
    organization = models.ForeignKey(
        Organization,
        related_name="endorsement_forms",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
    ...
    Co_PI1 = models.ForeignKey(
        PrincipleInvestigator,
        related_name="co_pi1_forms",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
    Co_PI2 = models.ForeignKey(
        PrincipleInvestigator,
        related_name="co_pi2_forms",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
    Co_PI3 = models.ForeignKey(
        PrincipleInvestigator,
        related_name="co_pi3_forms",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
    Co_PI4 = models.ForeignKey(
        PrincipleInvestigator,
        related_name="co_pi4_forms",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
    Co_PI5 = models.ForeignKey(
        PrincipleInvestigator,
        related_name="co_pi5_forms",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
    Co_PI6 = models.ForeignKey(
        PrincipleInvestigator,
        related_name="co_pi6_forms",
        on_delete=models.CASCADE,
        null=True,
        blank=True,
    )
    project_type = models.CharField(
        max_length=100, choices=PROJECT_TYPE, null=True, blank=True
    )
    ...
    funding_agency_type = models.CharField(
        max_length=100, choices=FUNDING_AGENCY_TYPE, null=True, blank=True
    )
    ...
    submission_type = models.CharField(
        max_length=100, choices=SUBMISSION_TYPE, null=True, blank=True
    )
    ...
    abstract = models.TextField(
        max_length=200,
        help_text="Abstract of the project (up to 200 words)",
        null=True,
        blank=True,
    )
    keywords = models.CharField(
        max_length=255,
        help_text="Keywords (5-6, comma separated)",
        null=True,
        blank=True,
    )
    informed_hod = models.CharField(
        max_length=3,
        choices=CHOICES,
        null=True,
        blank=True,
        help_text="Have you informed your HoD about this proposal?",
    )
    upload_hod_consent = models.CharField(
        max_length=3,
        choices=CHOICES,
        null=True,
        blank=True,
        help_text="Would you like to upload the reviews and consent from departmental HoD?",
    )
    hod_consent_pdf = models.FileField(
        upload_to="hod_consent/",
        blank=True,
        null=True,
        help_text="Upload PDF file. Max 10 MB.",
    )
    ...
    endorsement_required = models.CharField(
        max_length=3,
        choices=CHOICES,
        null=True,
        blank=True,
        help_text="Is an Endorsement form required?",
    )
    endorsement_template = models.FileField(
        upload_to="endorsement_templates/",
        blank=True,
        null=True,
        help_text="Upload 1 supported file: doc/docx/pdf. Max 10 MB.",
    )
    additional_comments = models.TextField(
        blank=True, null=True, help_text="Any additional comments"
    )
...
class Budget(models.Model):
    project = models.OneToOneField(
        EndorsementForm, on_delete=models.CASCADE, default=None
    )
    sanctiondate = models.DateField(blank=True, null=True)
    sanctionorder = models.CharField(
...
class RecievedAmount(models.Model):
    project = models.OneToOneField(
        EndorsementForm, on_delete=models.CASCADE, null=True, blank=True
    )
    Equipment = models.PositiveIntegerField()
    Consumables = models.PositiveIntegerField()
    Fellowship = models.PositiveIntegerField()
...
class Installment(models.Model):
    ...
    installment_year = models.ForeignKey(
        FinancialYear,
...
class Expenditure(models.Model):
    project = models.ForeignKey(EndorsementForm, on_delete=models.CASCADE)
    year = models.ForeignKey(
        FinancialYear, on_delete=models.CASCADE, null=True, blank=True
    )
